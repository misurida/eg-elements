...
You can use the following template for the *app.js* file:
```
...
if($app) {
    ...
    // import EgInput from './components/MyGlobalComponent.vue'
...
Then in you main .vue file (ex: Home.vue):
The variable *routeLogout* being store in the component *data* when *mounted()*:
...
let $app = document.getElementById('dashboard-app');
let base = "";
if($app)
